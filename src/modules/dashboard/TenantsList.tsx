            ...
            <div className="flex flex-1 w-full gap-4">
              ...
              <div className="flex w-full flex-1 flex-col gap-1">
                <div className="flex  items-center justify-between md:justify-start gap-4">
                  ...
                  {score && tenant.status === 'ativo' && <ScoreBadge score={score.score} scoreLabel={score.score_label} totalParcelas={score.total_meses} pagas={score.pagos_em_dia} pagasEmAtraso={score.pagos_em_atraso} vencidas={score.vencidos} diasAtrasoMaximo={score.dias_atraso_maximo} totalNotificacoes={score.total_notificacoes} totalAcordos={score.total_acordos} pontos={score.pontos} size="sm" />}
